package no.nav.veilarbperson.rest;
...
import no.nav.veilarbperson.consumer.portefolje.PortefoljeService;
...
import no.nav.veilarbperson.utils.AutentiseringHjelper;
