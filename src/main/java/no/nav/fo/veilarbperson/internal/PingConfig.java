...
public class PingConfig {
    ...
    public final static String ISSO_ISALIVE_URL = "ISSO_ISALIVE_URL";
    ...
    public Pingable issoPing() throws IOException {
        PingMetadata metadata = new Pingable.Ping.PingMetadata(
                "ISSO via " + getRequiredProperty(ISSO_ISALIVE_URL),
        ...
        return () -> {
            try {
                HttpURLConnection connection = (HttpURLConnection) new URL(getRequiredProperty(ISSO_ISALIVE_URL)).openConnection();
                connection.connect();
