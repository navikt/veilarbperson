...
public class SwaggerServlet extends HttpServlet {
    ...
    private static final String SWAGGER_BASE_URI_PARAMETER = "?input_baseurl=/veilarbperson/internal/api/swagger.json";
    private static final String SWAGGER_INDEX_PATH = "/veilarbperson/internal/swagger/index.html" + SWAGGER_BASE_URI_PARAMETER;
