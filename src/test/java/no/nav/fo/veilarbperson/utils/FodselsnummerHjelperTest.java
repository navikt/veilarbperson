...
import static no.nav.fo.veilarbperson.utils.FodselsnummerHjelper.fodselsnummerTilFodselsdato;
import static no.nav.fo.veilarbperson.utils.FodselsnummerHjelper.fodselsnummerTilKjoenn;
...
public class FodselsnummerHjelperTest {
    ...
    public void fodtI2039() {
        assertThat(fodselsnummerTilFodselsdato(FODSELSNUMMER_2039), is(FODSELSDATO_2039));
        assertThat(fodselsnummerTilFodselsdato(D_NUMMER_2039), is(FODSELSDATO_2039));
        assertThat(fodselsnummerTilFodselsdato(H_NUMMER_2039), is(FODSELSDATO_2039));
    }

    @Test
    public void fodtI2013() {
        assertThat(fodselsnummerTilFodselsdato(FODSELSNUMMER_2013), is(FODSELSDATO_2013));
        assertThat(fodselsnummerTilFodselsdato(D_NUMMER_2013), is(FODSELSDATO_2013));
        assertThat(fodselsnummerTilFodselsdato(H_NUMMER_2013), is(FODSELSDATO_2013));
    }

    @Test
    public void fodtI2000() {
        assertThat(fodselsnummerTilFodselsdato(FODSELSNUMMER_2000), is(FODSELSDATO_2000));
        assertThat(fodselsnummerTilFodselsdato(D_NUMMER_2000), is(FODSELSDATO_2000));
        assertThat(fodselsnummerTilFodselsdato(H_NUMMER_2000), is(FODSELSDATO_2000));
    }

    @Test
    public void fodtI1999() {
        assertThat(fodselsnummerTilFodselsdato(FODSELSNUMMER_1999), is(FODSELSDATO_1999));
        assertThat(fodselsnummerTilFodselsdato(D_NUMMER_1999), is(FODSELSDATO_1999));
        assertThat(fodselsnummerTilFodselsdato(H_NUMMER_1999), is(FODSELSDATO_1999));
    }

    @Test
    public void fodtI1930() {
        assertThat(fodselsnummerTilFodselsdato(FODSELSNUMMER_1930), is(FODSELSDATO_1930));
        assertThat(fodselsnummerTilFodselsdato(D_NUMMER_1930), is(FODSELSDATO_1930));
        assertThat(fodselsnummerTilFodselsdato(H_NUMMER_1930), is(FODSELSDATO_1930));
    }

    @Test
    public void fodtI1940() {
        assertThat(fodselsnummerTilFodselsdato(FODSELSNUMMER_1940), is(FODSELSDATO_1940));
        assertThat(fodselsnummerTilFodselsdato(D_NUMMER_1940), is(FODSELSDATO_1940));
        assertThat(fodselsnummerTilFodselsdato(H_NUMMER_1940), is(FODSELSDATO_1940));
    }

    @Test
    public void fodtI1854() {
        assertThat(fodselsnummerTilFodselsdato(FODSELSNUMMER_1854), is(FODSELSDATO_1854));
        assertThat(fodselsnummerTilFodselsdato(D_NUMMER_1854), is(FODSELSDATO_1854));
        assertThat(fodselsnummerTilFodselsdato(H_NUMMER_1854), is(FODSELSDATO_1854));
    }

    @Test
    public void ugyldigFodselsnummerFeiler() {
        assertNull(fodselsnummerTilFodselsdato(UGYLDIG_FODSELSNUMMER_1));
        assertNull(fodselsnummerTilFodselsdato(UGYLDIG_FODSELSNUMMER_2));
    }

    @Test
    public void fodselsnummerTilKjoennSkalOversetteMannRiktig() throws Exception {
        final String kjonn = fodselsnummerTilKjoenn("XXXXXXXX3XX");
    ...
    public void fodselsnummerTilKjoennSkalOversetteKvinneRiktig() throws Exception {
        final String kjonn = fodselsnummerTilKjoenn("XXXXXXXX4XX");
